...
const About = (): ReactElement => {
  return (
    <div className="m-md-4">
      <article
        className="d-flex flex-column text-wrap"
      ...
      >
        <div className="content">
          ...
          <p className="fs-6" role="para">
            Our success as one of the leading education service providers raised
            the expectations of many hopeful parents, who were keen to see their
        ...
        <div className="content mt-2">
          ...
          <p className="fs-6" role="para">
            The School intends to strive to become a second home for your child.
            The School located Hinjewadi Pune.
          </p>
        </div>
      </article>
    </div>
